...
export const LinkedInIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const InstagramIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const FacebookIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const YouTubeIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const WhatsAppIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const XIcon = ({ color = "#FFFFFF", size = 24, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
