...
const AboutHero = () => {
  return (
    <section className="py-20 flex flex-col items-center mx-auto text-center">
      ...
      <p className="text-sm sm:text-base leading-7 text-slate-300 max-w-2xl mb-8 text-center">
        ...
        decisions when equipped with the right insights.  We combine data, research, and technology to help organizations grow
        smarter.
      </p>
      <Mission />
    </section>
